    ...
    f6pS: [
      function (require, module, exports) {
        ...
        var e,
              ...
              p = function (e) {
                if (!e.hadRecentInput) {
                  ...
                  e.startTime - t.startTime < 5e3
                    ? ((f += e.value), m.push(e))
                    : ((f = e.value), (m = [e])),
                    f > s.value && ((s.value = f), (s.entries = m), n())
                }
              },
              g = a('layout-shift', p)
            g &&
          ...
          y = function (i, r) {
            e ||
              ((e = r), (t = i), (n = new Date()), S(removeEventListener), E())
          },
          E = function () {
            if (t >= 0 && t < n - h) {
              var r = {
          ...
          b = function (e, t) {
            var n,
              ...
              m = a('largest-contentful-paint', f)
            if (m) {
              n = c(e, s, t)
              var v = function () {
                F[s.id] ||
              ...
              ;['keydown', 'click'].forEach(function (e) {
                ...
                u(function (i) {
                  ;(s = r('LCP')),
                    ...
                    requestAnimationFrame(function () {
                      requestAnimationFrame(function () {
                        ;(s.value = performance.now() - i.timeStamp),
                          (F[s.id] = !0),
                          n(!0)
                      })
                    })
